...
Kssmat3_init = np.copy(Kssmat3)
cssmat_init = np.copy(cssmat)
Lssmat_init = np.copy(Lssmat)
...
gini_nocol(np.tile(Kssmat3_init.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))
gini_nocol(np.tile(Kssmat3.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))

gini_nocol(np.tile(income_init.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))
gini_nocol(np.tile(income.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))

gini_nocol(np.tile(cssmat_init.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))
gini_nocol(np.tile(cssmat.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))

gini_nocol(np.tile(Lssmat_init.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))
gini_nocol(np.tile(Lssmat.reshape(1, S, J), (T, 1, 1)), np.tile(omega_SS.reshape(1, S, J), (T, 1, 1)))
